...
const TrackPreview = ({ track }) => {
    ...
    return (
        <div onMouseEnter={handleMouseEnter}
            ...
            <Image loading="eager" id="element-of-mystery" unoptimized priority={true} className="w-full" src={track?.image} max-width={640} max-height={640} height={640} width={640} alt="Sunset in the mountains" layout="responsive"
                position="relative" />

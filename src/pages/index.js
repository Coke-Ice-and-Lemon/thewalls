  ...
  return (
    <>
      <div className="w-full flex flex-col items-center h-screen justify-center">
        <Image src="/idk258.svg" alt="The Walls Logo" width={100} height={100} />
        <h1 className='text-[#fffded] text-3xl font-bold'>THE WALLS</h1>
        
        <button 
          className="text-[#fffded] px-5 py-2 rounded-lg bg-[#1DB954] font-bold text-lg flex flex-row items-center my-5" 
        ...
        <button 
          className="text-[#fffded] px-5 py-2 rounded-lg bg-[#FF0000] font-bold text-lg flex flex-row items-center mb-5" 
          onClick={() => signIn('google', { callbackUrl: "/explore" })}
        >
          <Image src="/youtube.svg" alt='youtube_logo' width={20} height={20} />
          <p className='ml-1 font-sans'>

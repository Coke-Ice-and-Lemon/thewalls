        ...
        <>
            ...
            <div className="w-full  flex flex-col justify-center items-center mt-28">
                ...
                <div className="flex flex-col md:flex-row w-11/12 justify-center items-center mt-5">
                    <Link className="mr-3 mb-5" href={{ pathname: 'tracks', query: { time_range: 'short_term' } }}><button className=" bg-green-500 hover:bg-green-700 text-white font-bold text-[0.5rem] text-lg 
                px-3 py-2 lg:px-4 rounded" onClick={displayToast}>
                        Last Month
                    </button></Link>
                    <Link className="mr-3 mb-5" href={{ pathname: 'tracks', query: { time_range: 'medium_term' } }}><button className=" bg-green-500 hover:bg-green-700 text-white font-bold  text-[0.5rem] text-lg
                px-3 py-2 lg:px-8 rounded" onClick={displayToast}>
                        Last 6 Months
                    </button></Link>
                    <Link className="mr-3 mb-5" href={{ pathname: 'tracks', query: { time_range: 'long_term' } }}><button className=" bg-green-500 hover:bg-green-700 text-white font-bold  text-[0.5rem] text-lg
